...
namespace VieM::Utils {
	...
	void DrawButtonImage(const std::shared_ptr<VieM::Image>& imageNormal, const std::shared_ptr<VieM::Image>& imageHovered, const std::shared_ptr<VieM::Image>& imagePressed,
	...
	void DrawButtonImage(const std::shared_ptr<VieM::Image>& image,
		ImU32 tintNormal, ImU32 tintHovered, ImU32 tintPressed,
		ImVec2 rectMin, ImVec2 rectMax)
	{
...
// This border is going to be drawn even if window border size is set to 0.0f
	...
	bool BeginMenubar(const ImRect& barRectangle)
	{
		...
		ImRect bar_rect = Utils::RectOffset(barRectangle, 0.0f, padding.y);// window->MenuBarRect();
