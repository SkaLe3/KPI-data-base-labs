...
bool ModelBase::Connect(const std::string& dbname , const std::string& username, const std::string& password, std::string& errorMessage)
{
...
bool ModelBase::CreateTables(std::string& errorMessage)
{
	errorMessage = "";
	std::string error;
...
std::shared_ptr<TableData> ModelBase::FetchTableData(Table table, std::vector<std::string> pkeysTitles, std::string& errorMessage)
{
...
bool ModelBase::CreateRecord(Table table, std::vector<std::string> data, std::string& errorMessage)
{
	std::string query;
...
bool ModelBase::UpdateRecord(Table table, std::vector<std::string> data, std::vector<Column> keys, std::vector<std::string> oldData, std::string& errorMessage)
{
...
bool ModelBase::DeleteRecord(Table table, std::vector<Column> pkeyColumns, std::vector<std::string> pkeysData, std::string& errorMessage)
{
...
std::vector<std::string> ModelBase::GetRecordIfExists(Table table, std::vector<Column> columns, std::vector<std::string> data, std::string& errorMessage)
{
...
std::vector<std::string> ModelBase::GetPKeyColumnTitles(Table table, std::string& errorMessage)
{
...
bool ModelBase::GenerateData(Table table,int32_t rowCount, std::string& errorMessage)
{
	bool success = true;
	switch (table)
	{
...
bool ModelBase::CheckTableMinRecords(Table table, int32_t count)
{
	std::string tableName = TableSpecs::GetName(table);
...
std::vector<std::string> ModelBase::GetListOfGenres(std::string& errorMessage)
{
...
std::pair<std::shared_ptr<TableData>, std::vector<std::string>> ModelBase::ExecuteFirstSelection(int32_t age, int32_t songCount,int32_t genreId, std::string genre, std::string& errorMessage)
{
	std::string query =
...
std::pair<std::shared_ptr<TableData>, std::vector<std::string>> ModelBase::ExecuteSecondSelection(const std::string& fromDate, const std::string& toDate, std::string& errorMessage)
{
	std::string query =
...
std::pair<std::shared_ptr<TableData>, std::vector<std::string>> ModelBase::ExecuteThirdSelection(const std::string& fromDate, const std::string& toDate, std::string& errorMessage)
{
	std::string query =
		"WITH new_song AS( "
...
bool ModelBase::LoadTestDataSamples(std::string& errorMessage)
{
	errorMessage = "Failed to load test data samples";
	return m_SampleDataStorage.LoadFiles();
}

bool ModelBase::CreateAuxiliaryTablesForTestData(std::string& errorMessage)
{
	errorMessage = "Failed to create auxiliary tables";
	return m_SampleDataStorage.CreateTables();
}

std::string ModelBase::CreateTableGenre()
{
...
std::string ModelBase::CreateTableLabel()
{
	const char* createTableSQL = 
...
std::string ModelBase::CreateTableAlbum()
{
	const char* createTableSQL =
...
std::string ModelBase::CreateTableSong()
{
	const char* createTableSQL = 
...
std::string ModelBase::CreateTablePerson()
{
	const char* createTableSQL =
...
std::string ModelBase::CreateTableArtist()
{
	const char* createTableSQL =
...
std::string ModelBase::CreateTableArtist_Person()
{
	const char* createTableSQL =
...
std::string ModelBase::CreateTableArtist_Song()
{
	const char* createTableSQL =
...
std::string ModelBase::CheckCreateResult(PGresult* res, ExecStatusType status, const std::string& text)
{
